...
Class names in Kohana follow a strict convention to facilitate [autoloading](/documentation/system/autoloading). Class names should have uppercase first letters with underscores to separate words. Underscores are significant as they directly reflect the file location in the filesystem.
...
3. All classes should be in the `classes` directory. This may be at any level in the [cascading filesystem](/documentation/system/files).
