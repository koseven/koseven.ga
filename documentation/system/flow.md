...
2. Once we are in `bootstrap.php`:
	...
	9. [Kohana::modules] is called to enable additional modules.
	    * Module paths are added to the [cascading filesystem](/documentation/system/files).
	...
	10. [Route::set] is called multiple times to define the [application routes](/documentation/system/routing).
	11. [Request::factory] is called to start processing the request.
		...
		5. Calls the [Controller::after] method.
		    * The above 5 steps can be repeated multiple times when using [HMVC sub-requests](/documentation/system/requests).
